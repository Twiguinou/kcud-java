...
public class CommandPool implements Disposable
{
    ...
    private final LogicalDevice.Queue m_queue;

    public CommandPool(VkDevice device, int flags, final LogicalDevice.Queue queue) throws VulkanException
    {
        this.device = device;
    ...
    public LogicalDevice.Queue getQueue()
    {
        return this.m_queue;
    }
